...
class StressTestGUI:
    ...
    def setup_ui(self):
        ...
        high_frame, high_inner = make_section(
            settings_inner,
            "▦ All Cores",
            padding=6
        )
        ...
        low_frame, low_inner = make_section(
            settings_inner,
            "≡ Low Load",
            padding=6
        )
        ...
        self.browsers_label = ttk.Label(
            browser_inner,
            text="Instances"
        )

        self.browsers_label.grid(
            row=0,
            column=0,
            sticky="w",
            padx=(0, 0),
        ...
        self.browsers_spinbox = configure_numeric_spinbox(
            ttk.Spinbox(
                ...
                to=99,
                width=6,
                textvariable=self.browsers_var
            )
        )

        self.browsers_spinbox.grid(
            row=0,
            column=1,
            sticky="ew",
            pady=3
