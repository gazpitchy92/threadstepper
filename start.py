...
class StressTestGUI:
    ...
    def setup_ui(self):
        ...
        ttk.Label(cores_row, text="Cores/Threads:", style="InfoTitle.TLabel").pack(
            side="left"
        )
        ...
        ttk.Label(freq_row, text="Frequency:", style="InfoTitle.TLabel").pack(
            side="left"
        )
        ...
        clock_frame_bottom.grid(
            row=1, column=1, columnspan=2, sticky="nsew", padx=(5, 0)
        )
        ...
        ttk.Button(
            ...
            text="↻ Refresh",
            bootstyle="info-outline",
            command=lambda: update_error_status(self),
        ...
        self.error_text = scrolledtext.ScrolledText(
            error_log_inner, width=80, height=6, wrap="word", font=("Segoe UI", 12)
        )
        ...
        ttk.Button(
            ...
            text="↻ Refresh",
            bootstyle="info-outline",
            command=lambda: update_error_log(self),
        ).pack(side="right", padx=2)
        ...
        ttk.Button(
            ...
            command=lambda: clear_error_log(self),
        ).pack(side="right", padx=2)
        ...
        self.unsaved_label = ttk.Label(
            save_frame, text="", foreground="#e67e00", font=("Segoe UI", 11, "italic")
        )
        ...
        ttk.Button(
            ...
            text="⤓ Save Settings",
            bootstyle="success",
            command=lambda: save_settings(self),
        ).pack(side="right")
        ...
        self.output_text = scrolledtext.ScrolledText(
            output_inner, width=80, height=2, wrap="word", font=("Segoe UI", 11)
        )
        ...
        ttk.Label(runs_frame, text="Test Runs", font=("Segoe UI", 9)).pack(
            side="left", padx=(0, 4)
        )
        ...
        style.configure(
            "Green.Horizontal.TProgressbar", troughcolor="#e0e0e0", background="#28a745"
        )
